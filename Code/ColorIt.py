...
class Ui_Form(QtGui.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.home_cmb.setGeometry(QtCore.QRect(40, 210, 141, 41))
...
"color: rgb(255, 255, 255);"))
        ...
        self.sum_cmb = QtGui.QCommandLinkButton(self.Menu)
        self.sum_cmb.setGeometry(QtCore.QRect(40, 360, 185, 41))
        self.sum_cmb.setAutoFillBackground(False)
        self.sum_cmb.setStyleSheet(_fromUtf8("background-color: rgb(122,117,116);\n"
"font: 75 20pt \"Century Gothic\";\n"
"color: rgb(255, 255, 255);"))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/summary-icon-png-and-since-the-procedure-24.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.sum_cmb.setIcon(icon1)
        self.sum_cmb.setIconSize(QtCore.QSize(30, 30))
        self.sum_cmb.setAutoDefault(False)
        self.sum_cmb.setDefault(False)
        self.sum_cmb.setObjectName(_fromUtf8("sum_cmb"))
...
""))
        ...
        self.sum_tab = QtGui.QWidget(Form)
        self.sum_tab.setGeometry(QtCore.QRect(300, -1, 511, 581))
        self.sum_tab.setStyleSheet(_fromUtf8(""))
        self.sum_tab.setObjectName(_fromUtf8("sum_tab"))
        self.label = QtGui.QLabel(self.sum_tab)
        self.label.setGeometry(QtCore.QRect(50, 119, 391, 371))
        ...
        QtCore.QObject.connect(self.home_cmb, QtCore.SIGNAL(_fromUtf8("clicked()")), self.sum_tab.hide)
        QtCore.QObject.connect(self.home_cmb, QtCore.SIGNAL(_fromUtf8("clicked()")), self.up_pic.show)
        QtCore.QObject.connect(self.sum_cmb, QtCore.SIGNAL(_fromUtf8("clicked()")), self.sum_tab.show)
        QtCore.QObject.connect(self.sum_cmb, QtCore.SIGNAL(_fromUtf8("clicked()")), self.up_pic.hide)
        ...
        QtCore.QObject.connect(self.sum_cmb, QtCore.SIGNAL(_fromUtf8("clicked()")), self.widget.hide)
        QtCore.QObject.connect(self.color, QtCore.SIGNAL(_fromUtf8("clicked()")), self.up_pic.hide)
        QtCore.QObject.connect(self.color, QtCore.SIGNAL(_fromUtf8("clicked()")), self.sum_tab.hide)
    ...
    def retranslateUi(self, Form):
        ...
        self.home_cmb.setText(_translate("Form", "Home", None))
        self.sum_cmb.setText(_translate("Form", "About", None))
        ...
        self.label.setText(_translate("Form", "This project colorises the black and white images into color.", None))
        self.color.hide()
